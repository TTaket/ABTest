...
func (c *experimentClient) GetExperimentUserBinding(ctx context.Context, in *pb.GetExperimentUserBindingRequest, opts ...grpc.CallOption) (*pb.GetExperimentUserBindingResponse, error) {
