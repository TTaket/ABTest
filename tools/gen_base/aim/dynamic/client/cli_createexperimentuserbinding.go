...
func (c *experimentClient) CreateExperimentUserBinding(ctx context.Context, in *pb.CreateExperimentUserBindingRequest, opts ...grpc.CallOption) (*pb.CreateExperimentUserBindingResponse, error) {
