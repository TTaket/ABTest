...
func (c *experimentClient) DeleteLayerUserBinding(ctx context.Context, in *pb.DeleteLayerUserBindingRequest, opts ...grpc.CallOption) (*pb.DeleteLayerUserBindingResponse, error) {
