...
func (c *experimentClient) GetLayerUserBinding(ctx context.Context, in *pb.GetLayerUserBindingRequest, opts ...grpc.CallOption) (*pb.GetLayerUserBindingResponse, error) {
