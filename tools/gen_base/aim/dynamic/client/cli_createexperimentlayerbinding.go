...
func (c *experimentClient) CreateExperimentLayerBinding(ctx context.Context, in *pb.CreateExperimentLayerBindingRequest, opts ...grpc.CallOption) (*pb.CreateExperimentLayerBindingResponse, error) {
