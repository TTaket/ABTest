...
func (c *experimentClient) DeleteExperimentLayerBinding(ctx context.Context, in *pb.DeleteExperimentLayerBindingRequest, opts ...grpc.CallOption) (*pb.DeleteExperimentLayerBindingResponse, error) {
