...
func (c *experimentClient) DeleteExperimentUserBinding(ctx context.Context, in *pb.DeleteExperimentUserBindingRequest, opts ...grpc.CallOption) (*pb.DeleteExperimentUserBindingResponse, error) {
