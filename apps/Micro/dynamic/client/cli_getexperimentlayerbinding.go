...
func (c *dynamicClient) GetExperimentLayerBinding(ctx context.Context, in *pb.GetExperimentLayerBindingRequest, opts ...grpc.CallOption) (*pb.GetExperimentLayerBindingResponse, error) {
