...
func (c *dynamicClient) GetLayerExperiments(ctx context.Context, in *pb.GetLayerExperimentsRequest, opts ...grpc.CallOption) (*pb.GetLayerExperimentsResponse, error) {
