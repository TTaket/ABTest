...
func (c *dynamicClient) CreateLayerUserBinding(ctx context.Context, in *pb.CreateLayerUserBindingRequest, opts ...grpc.CallOption) (*pb.CreateLayerUserBindingResponse, error) {
