...
var (
	confFile = flag.String("dynamic_confpos", "./configs/dynamic.yml", "The configuration file path")
	grpcPort = flag.Int("dynamic_port", 50054, "The server port")
	serverID = flag.Int("dynamic_id", 1, "The server id")
)
var (
	config = new(Config)
	bInit  = false
